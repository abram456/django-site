function open_close_instagreeter(obj) {
    id = $(obj).attr('data-id');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if ($(obj).attr('closed')==1) {
                    $('.close_instagreeter').removeClass('hide');
                    $('.reopen_instagreeter').addClass('hide');
                    $('.closeit').removeClass('vclosed');
                    $('.openit').addClass('hide');
                } else if ($(obj).attr('closed')==0) {
                    $('.reopen_instagreeter').removeClass('hide');
                    $('.close_instagreeter').addClass('hide');
...
function match_action(obj) {
    instagreeter_id = $('#instagreeter_id').val();
    ...
    if (volunteer_id==''||volunteer_id==undefined) {
        ...
        url = 'admin/instagreeter/ajax_update/'+$(obj).attr('action');
    }
...
function bind_match_buttons() {
    ...
    var instagreeter_id = $('#instagreeter_id').val();
    ...
    $('.match_volunteer_action_assign').unbind('click').click(function(event) {
        ...
        var context_string = 'Instagreeter|' + id + '||Volunteer|' + volunteer_id;
